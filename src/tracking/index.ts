...
export { ExponentialSmoother, Vector3ExponentialSmoother } from "./ExponentialSmoother";
...
export type { FeatureAnchorOptions, AnchorFeature, ReprojectionResult } from "./FeatureAnchor";
